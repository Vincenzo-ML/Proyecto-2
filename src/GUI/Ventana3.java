...
public class Ventana3 extends javax.swing.JFrame {
    ...
    //ArrayList<Persona> usersList = new ArrayList<Persona>();
    ...
    public void mostrarUsuarios(){
        model.addElement( "NOMBRE DE USUARIO, TIPO DE USUARIO");
        ...
        if (v1.list.isEmpty() == false){
            for (int x = 0; x < v1.list.len(); x++){
                ...
                model.addElement( name + "" +priority);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(279, 19, 40, 30));

        jScrollPane4.setViewportView(jListUsers);

        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, -1, -1));

        background.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 350, 500));
        ...
        background.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 400, -1, -1));
